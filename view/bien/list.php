<div class="produits">
    ...
    if(empty($_SESSION['login'])){
        echo '<a <button href="index.php?controller=membre&action=create" style="margin-left:35%;" class="w3-button w3-xlarge w3-theme w3-hover-teal" title="S\'inscrire">Inscrivez-vous d̬s maintenant !</button></a><br>';
    }
        foreach($tab_b as $b){ 
