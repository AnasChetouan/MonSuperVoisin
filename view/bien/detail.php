    ...
    echo '
           <p><b> Titre : </b> '.$titreHTML . '<br> <br>'
             .'<img src='.$lienPhoto.' alt="photo bien" height="25%" width="25%" > <br> <br>'.
              ...
              if (isset($_SESSION['login']) && $_SESSION['login'] != ModelMembre::getLoginById($idProprio) && Session::is_admin()){
                  echo '</br><a href="index.php?controller=bien&action=update&id='.$idBien.'"> <button>Modifier ce post</button></a> </br>';
              }
