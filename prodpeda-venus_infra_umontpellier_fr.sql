...
-- Généré le :  mer. 14 nov. 2018 à 17:14
...
--
CREATE DATABASE IF NOT EXISTS `mdimarino` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mdimarino`;
...
INSERT INTO `Bien` (`idBien`, `titre`, `description`, `tarif`, `motClef`, `estValide`, `lienPhoto`, `prixNeuf`, `estDispo`) VALUES
(1, 'Four à louer', 'Four électrique 150W, à louer dans les alentours de Montpellier', 0, 'Electro-ménager', 0, 'à définir', 150, 1),
(2, 'Perceuse comme neuve', 'Je mets à disposition une perceuse pour tous vos travaux à domicile', 0, 'Bricolage', 0, 'à définir', 150, 1);
...
CREATE TABLE `Membre` (
  ...
  `nbConso` int(11) NOT NULL,
  `nbPropo` int(11) NOT NULL,
...
INSERT INTO `Membre` (`idMembre`, `login`, `nom`, `prenom`, `adresse`, `mail`, `mdp`, `ville`, `telephone`, `note`, `admin`, `nbConso`, `nbPropo`, `codePostal`, `dateInscription`, `solde`, `nonce`) VALUES
(6, 'Luca347', 'DiMarino', 'Luca', '26 rue des lilas', 'luca@gmail.com', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Sete', 678698547, 0, 1, 0, 0, 34200, '2018-11-10', 0, 0),
(7, 'Marco347', 'DiMarino', 'Marco', '26 rue des rossignols', 'cocolepolo@gmail.com', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Sete', 659874156, 0, 0, 0, 0, 34200, '2018-11-10', 0, 0),
(10, 'AnasMontanas', 'Chetouan', 'Anas', '30 avenue du pres', 'anas@hotmail.fr', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Montpellier', 698574815, 0, 0, 0, 0, 34000, '2018-11-10', 0, 1);
...
--
-- Structure de la table `ProposeBien`
--

CREATE TABLE `ProposeBien` (
  `idMembre` int(11) NOT NULL,
  `idBien` int(11) NOT NULL
...
--
-- Structure de la table `ProposeService`
--

CREATE TABLE `ProposeService` (
  `idMembre` int(11) NOT NULL,
...
INSERT INTO `Service` (`idService`, `titre`, `description`, `tarif`, `motClef`, `estValide`, `dateDebut`, `dateFin`, `dispo`) VALUES
(1, 'Baby-sitter', 'Je propose mes service de baby-sitter dans les alentours de Montpellier', 12, 'Babysitting', 0, '2018-11-07', '2018-11-30', '');
...
--
-- Index pour la table `ProposeBien`
--
ALTER TABLE `ProposeBien`
  ADD PRIMARY KEY (`idMembre`,`idBien`),
  ADD KEY `fk2_pb` (`idBien`);

--
-- Index pour la table `ProposeService`
--
ALTER TABLE `ProposeService`
  ADD PRIMARY KEY (`idMembre`,`idService`),
  ADD KEY `fk2_ps` (`idService`);
...
--
ALTER TABLE `Commentaire`
  MODIFY `idComm` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Contraintes pour la table `ProposeBien`
--
ALTER TABLE `ProposeBien`
  ADD CONSTRAINT `fk1_pb` FOREIGN KEY (`idMembre`) REFERENCES `Membre` (`idMembre`),
  ADD CONSTRAINT `fk2_pb` FOREIGN KEY (`idBien`) REFERENCES `Bien` (`idBien`);

--
-- Contraintes pour la table `ProposeService`
--
ALTER TABLE `ProposeService`
  ADD CONSTRAINT `fk1_ps` FOREIGN KEY (`idMembre`) REFERENCES `Membre` (`idMembre`),
  ADD CONSTRAINT `fk2_ps` FOREIGN KEY (`idService`) REFERENCES `Service` (`idService`);
COMMIT;
