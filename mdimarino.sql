...
-- Généré le :  Dim 09 déc. 2018 à 20:48
...
(3, 'Perceuse', 'Perceuse de marque Bosch en très bon état, à louer', 1, 'bricolage', 0, 'uploads/3.jpeg', 200, 0, 6),
(5, 'Marteau', 'J\'aime mon marteau', 0, 'bricolage', 0, 'uploads/5.jpg', 50, 1, 7),
(10, 'Souris', 'Souris en bon état à louer', 0, 'informatique', 0, 'uploads/10.png', 30, 1, 10),
(11, 'Aspirateur', 'A louer aspirateur de très bonne qualité', 1, 'electromenager', 0, 'uploads/11.jpg', 180, 1, 6);
...
INSERT INTO `Emprunt` (`idEmprunt`, `idProposant`, `idAcceptant`, `idProduit`, `estBien`, `dateDebut`, `dateFin`) VALUES
(11, 7, 6, 3, 1, '2018-11-28 00:00:00.000', '2018-11-29 00:00:00.000');
...
(6, 'Luca347', 'DiMarino', 'Luca', '26 rue des lilas', 'luca@gmail.com', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Sete', 678698547, 1, 34200, '2018-11-10', 0, 0),
(7, 'Marco347', 'DiMarino', 'Marco', '26 rue des rossignols', 'cocolepolo@gmail.com', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Sete', 659874156, 0, 34200, '2018-11-10', 0, 0),
(10, 'AnasMontanas', 'Chetouan', 'Anas', '30 avenue du pres', 'anas@hotmail.fr', '019d82c3732fe6050b775e0f17a7903fa8de5aae66c6479c8c0af7651a057597', 'Montpellier', 698574815, 0, 34000, '2018-11-10', 0, 0);
...
CREATE TABLE `Service` (
  ...
  `motClef` varchar(75) NOT NULL,
  `estValide` tinyint(1) NOT NULL,
  `disponibilites` longtext NOT NULL,
  `idProprio` int(75) NOT NULL
...
INSERT INTO `Service` (`idService`, `description`, `tarif`, `motClef`, `estValide`, `disponibilites`, `idProprio`) VALUES
(2, 'Professeur d\'anglais depuis 10 ans, je propose mes services pour vous perfectionner dans la langue en un temps record !', 12, 'Cours de langue', 0, 'Lundi : De 18h à 20h\nMercredi : De 15h à 20h\nSamedi : De 10h à 20h\nDimanche : De 10h à 18h\n', 10),
(3, 'Etudiant disponible en soirée pour du baby-sitting de 3 à 10 ans. J\'ai de l\'expérience depuis 3 ans et j\'aime le contact avec les enfants !', 11, 'Babysitting', 0, 'Lundi : De 17h à 20h\nMardi : De 17h à 20h\nMercredi : De 17h à 20h\nJeudi : De 17h à 20h\nVendredi : De 17h à 20h\n', 6),
(4, 'Envie de monter un meuble rapidement et efficacement ? Faites appel à moi !', 15, 'Montage', 0, 'Vendredi : De 18h à 22h\nSamedi : De 10h à 20h\nDimanche : De 10h à 20h\n', 7);
...
--
ALTER TABLE `Bien`
  MODIFY `idBien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
